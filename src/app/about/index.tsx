  ...
  return (
    <div className="flex animate-up flex-col gap-y-4 sm:gap-y-6">
      ...
      <Link
        ...
        className="text-foreground group flex w-fit select-none items-center justify-center gap-2 rounded-radius border border-solid border-border px-4 py-3 text-sm hover:bg-border focus-visible:bg-border"
      >
