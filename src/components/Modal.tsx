        ...
        <div className="overflow-y-auto px-4 pb-2 pt-1.5">
            ...
            {socialMedia.map((media, index) => {
              ...
              return (
                <Link
                  ...
                  target="_blank"
                  href={newMedia.link}
                  className="row group flex h-10 w-full select-none items-center gap-2 rounded-def px-2.5 py-2 text-sm text-color-paragraphy hover:bg-link-hover hover:text-white active:bg-link-active"
                >
                  {newMedia.svg}
                  {newMedia.name}
                </Link>
          ...
          <nav className="flex flex-col gap-1">
            <button
              ...
              className="row group flex h-10 w-full items-center gap-2 rounded-def px-2.5 py-2 text-sm text-color-paragraphy hover:bg-link-hover hover:text-white active:bg-link-active"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
