        ...
        <div className="overflow-y-auto px-3 pb-2 pt-1.5">
            ...
            {socialMedia.map((media, index) => {
              ...
              return (
                <Link
                  ...
                  target="_blank"
                  href={newMedia.link}
                  className="row hover:text-primary group flex h-10 w-full select-none items-center gap-2 rounded-def px-2.5 py-2 text-sm text-gray-100 hover:bg-hover active:bg-active"
                >
                  {newMedia.svg}
                  {newMedia.name}
                </Link>
          ...
          <nav className="flex flex-col gap-1">
            <button
              ...
              className="row hover:text-primary group flex h-10 w-full items-center gap-2 rounded-def px-2.5 py-2 text-sm text-gray-100 hover:bg-hover active:bg-active"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
