  ...
  return (
    <nav className="flex flex-wrap gap-3">
      <Link
        ...
        className="flex w-full max-w-fit items-center gap-1.5 rounded-def border border-solid border-gray-2 px-2.5 py-2 text-sm font-medium text-gray-1 hover:bg-gray-2"
      >
        <svg
      ...
      <Link
        ...
        className="flex w-full max-w-fit items-stretch gap-1.5 rounded-def border border-solid border-gray-2 px-2.5 py-2 text-sm font-medium text-gray-1 hover:bg-gray-2"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
